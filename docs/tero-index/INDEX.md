# py-rust-bridge — Tero Index (Layer 1)
...
|---|---|---|---|---|---|---|
| `agents` | other | — | AGENTS.md — py-rust-bridge | `AGENTS.md:2` | — | Use Tero + cabal-devmelopner for work here. |
...
| `readme--features` | section | — | Features | `README.md:25` | — | - PyO3 Bindings Generation: Automatic generation of PyO3 Rust extensions from Python project metadata |
| `readme--dependencies` | section | — | Dependencies | `README.md:32` | — | - Compatible with PyO3 (Apache-2.0/MIT dual license) |
| `readme--development` | section | — | Development | `README.md:38` | — | This project uses [uv](https://github.com/astral-sh/uv) for dependency management. |
| `readme--install-dependencies` | other | — | Install dependencies | `README.md:43` | — | uv sync |
